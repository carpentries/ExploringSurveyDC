...
## 'scripts/installpkg.R': No such file or directory
```
...
```
## /Library/Fonts/Tahoma Bold.ttf : Tahoma-Bold already registered in fonts database. Skipping.
## /Library/Fonts/Tahoma.ttf : Tahoma already registered in fonts database. Skipping.
